import { CreateCompanyBodyDTO } from '../../../../../src/modules/company/dtos/company.controller.dtos';
import { baseCompanyData, newLogo } from '.';

export const createCompanyBody: CreateCompanyBodyDTO = {
...
export const createCompanyResponse = (id) => ({
  result: true,
  company: {
    id,
    address: 'Some address',
